...
echo Iniciando proceso del Batch BatchArquetipo

REM Lanzamos la aplicacion
"%JAVA_BIN%"\java -Dlogs.batch.path=%1 -classpath %classpath% es.jmpalma.arquetipo.batch.Lanzador

echo Proceso Finalizado del Batch BatchArquetipo. Consultar el log para mas informacion
