...
public class ConstantesIntegraSqlMapDao extends SqlMapClientDaoSupport implements ConstantesIntegraDao{
	...
	/* (non-Javadoc)
	 * @see es.jmpalma.arquetipo.util.ConstantesIntegraDao#obtenerValorConstante(java.lang.String)
	 */
	...
	/* (non-Javadoc)
	 * @see es.jmpalma.arquetipo.util.ConstantesIntegraDao#obtenerValorSecuencia(java.lang.String)
	 */
