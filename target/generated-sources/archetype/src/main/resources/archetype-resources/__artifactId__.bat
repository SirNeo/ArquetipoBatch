...
echo Iniciando proceso del Batch ${artifactId}

REM Lanzamos la aplicacion
"%JAVA_BIN%"\java -Dlogs.batch.path=%1 -classpath %classpath% ${package}.batch.Lanzador

echo Proceso Finalizado del Batch ${artifactId}. Consultar el log para mas informacion
