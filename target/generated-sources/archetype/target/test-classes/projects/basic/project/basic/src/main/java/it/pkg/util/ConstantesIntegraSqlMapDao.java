...
public class ConstantesIntegraSqlMapDao extends SqlMapClientDaoSupport implements ConstantesIntegraDao{
	...
	/* (non-Javadoc)
	 * @see it.pkg.util.ConstantesIntegraDao#obtenerValorConstante(java.lang.String)
	 */
	...
	/* (non-Javadoc)
	 * @see it.pkg.util.ConstantesIntegraDao#obtenerValorSecuencia(java.lang.String)
	 */
