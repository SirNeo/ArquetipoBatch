...
public class ExcepcionNegocio extends Exception {
	...
	/** Indica que se ha producido un error de conexi�n a BBDD */
	public static final int ERROR_BASE_DATOS = 101;

	/** Indica que se est� intentando acceder a una funcionalidad
	 * no permitida para el usuario */
	public static final int ERROR_ACCESO = 102;

	/** Indica que se ha producido un error en los par�metros
	 * con los que se accede a una p�gina */
	...
	/** Indica que se ha producido un error en la conversi�n entre tipos de 
	 * datos */
	 ...
	 *  las fechas en las tablas de Hist�ricos del Acta */
	...
	/** Indica que se ha producido un error al enviar la comunicaci�n al LVE */
	...
	/** Indica que se ha producido un error en el envio a Inteco por el campo n�mero y
	 * no queremos que se nos concatene la descripci�n p�ngase en contacto con el CAU*/
	public static final int ERROR_ENVIO_PETICION_INTECO_2 = 208;

	/** Indica que se ha producido un error en el envio a notificaci�n Inteco*/
